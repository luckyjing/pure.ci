...
export default class CustomerContainer extends Component {
  ...
  addBlackList(index){
    ...
    actions.addBlackCus(this.props.state.customerList[index].userId,index);
  }

  deleteCustomer(index){
    const {actions} = this.props;
    actions.deleteCus(this.props.state.customerList[index].userId,index);
  }
  ...
  render() {
    ...
    return (
      <div>
            <div>
              <PageTitle title={[{title: 'Customer'}]}/>
            </div>
            {arr}
      </div>
    );
